...
--QUERY 7
SELECT vendor.vendor_id, vendor.vendor_name, vendor_booth_assignments.market_date
FROM vendor
...
--QUERY 8
SELECT vendor_id, COUNT(*) as count_of_bookings
...
LEFT JOIN customer ON customer.customer_id = customer_purchases.customer_id
